// Main JavaScript para Linux Desde Cero

document.addEventListener('DOMContentLoaded', function() {
    console.log('☕ Linux Desde Cero - Sitio cargado correctamente');
    ...
    console.log('%c☕ ¡Bienvenido a Linux Desde Cero!', 'font-size: 20px; color: #e95420; font-weight: bold;');
});
